...
jQuery(function (n) {
    ...
    var t = function (e) {
        ...
        e = function (e) {
            for (var t = encodeURI(e) + "=", i = document.cookie.split(";"), o = 0; o < i.length; o++) {
                for (var n = i[o]; " " === n.charAt(0);)
                    n = n.substring(1, n.length);
                if (0 === n.indexOf(t))
    ...
    function z() {
        ...
        d("body").on("click", ".js-product-favorite, .js-shop-item-favorite", function (e) {
            var i = parseInt(u.text());
            isNaN(i) && (i = 0),
                e.preventDefault();
            var e = d(e.currentTarget),
                o = parseInt(e.data("product_id"));
            e.blur(),
                d(document)
        ...
        void 0 !== window.isMobile && window.isMobile
            ...
            : v(document).on("click", ".js-shop-item-quick", function (e) {
                e.preventDefault();
                var e = v(this),
                    i = v(".js-quick-view-holder"),
                    o = v(".js-quick-view-container"),
                    t = e.parents(".shop-item");
                function n(e) {
                    v(e.target)
                        .closest(o)
        ...
        (N = n)(document).on("click", ".quantity-minus, .quantity-plus", function (e) {
            var t = N(this),
                ...
                o = parseFloat(i.val());
            o && "" !== o && "NaN" !== o || (o = 0);
            var n = parseFloat(i.attr("max"));
            "" !== n && "NaN" !== n || (n = "");
            var a = parseFloat(i.attr("min"));
            "" !== a && "NaN" !== a || (a = 0);
            var s = i.attr("step");
    ...
    var M,
        ...
        t = n("#top-menu"),
        I = n(".widget-mobile-menu ul"),
        Q = n(".js-mobile-menu-placeholder"),
        t = t.clone(),
        I = I.clone();
        ...
        const cartIcon = document.querySelector('.header-cart'),
              ...
              searchHeader = document.querySelector('.header-search'),
              cloneSearchHeader = searchHeader.cloneNode(true),
        ...
        cloneSearchHeader.classList.add('header-search-only-hamburger');

        mobileIconWrapper.appendChild(cloneSearchHeader);
        ...
        E.on("click", function () {
            ...
            searchHeader.toggleAttribute('hidden')
    ...
    jQuery(function (t) {
        ...
        t(document).on("click", ".js-table-of-contents-hide", function () {
            var e = t(this).parents(".table-of-contents");
            e.toggleClass("open"),
                e.hasClass("open")
    ...
    jQuery(function (l) {
        ...
        l(document).on("click", ".js-star-rating-item", function () {
            var o = l(this),
                ...
                a = o.data("score"),
                e = n.data("post-id"),
                s = n.data("rating-count"),
                r = n.data("rating-sum"),
                c = n.data("rating-value");
            function d(e, t) {
        ...
        u = (e(Ct, s), t(Ct, [
            {
                ...
                value: function () {
                    var n = document.createElement("script"),
                        a = document.querySelectorAll('[data-counter="vkontakte"]'),
                        t = "https://vk.com/share.php?act=count&index=1&url=".concat(this.url);
        ...
        v = (e(bt, s), t(bt, [
            {
                ...
                value: function () {
                    var n = document.createElement("script"),
                        a = document.querySelectorAll('[data-counter="odnoklassniki"]'),
                        t = "https://connect.ok.ru/dk?st.cmd=extLike&uid=1&ref=".concat(this.url);
                    window.ODKL = {},
...
!function (e, t) {
    ...
    var s,
        ...
        w = {
            updateSize: function () {
                var e = this.$el,
                    t = void 0 !== this.params.width
                        ? this.params.width
                        : e[0].clientWidth,
                    i = void 0 !== this.params.height
                        ? this.params.height
                        : e[0].clientHeight;
        ...
        P = (b = j.navigator.platform, s = j.navigator.userAgent, a = {
            ios: !1,
            android: !1,
            androidChrome: !1,
            desktop: !1,
            ...
            handle: function (e) {
                ...
                if (s.invert && (a = -a), i.params.freeMode) {
                    ...
                    if (!r) {
                        ...
                        var l,
                            d,
                            h = i.getTranslate() + a * s.sensitivity,
                            n = i.isBeginning,
                            s = i.isEnd;
                    ...
                    if (this.params.loop
                        ...
                        if (s.dynamicBullets && (this.pagination.bulletSize = p.eq(0)[this.isHorizontal()
                            ...
                            if (c.addClass(s.bulletActiveClass), s.dynamicBullets) {
                                for (var t = p.eq(r), c = p.eq(o), m = r; m <= o; m += 1)
            ...
            render: function () {
                ...
                if (e.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                    var t = (this.virtual && this.params.virtual.enabled
                        ...
                        s = "";
                    if ("bullets" === e.type) {
                        for (var a = this.params.loop
                            ? Math.ceil((t - 2 * this.loopedSlides) / this.params.slidesPerGroup)
                            : this.snapGrid.length, n = 0; n < a; n += 1)
                            e.renderBullet
        ...
        Y = {
            ...
            setDragPosition: function (e) {
                var t = this.scrollbar,
                    ...
                    n = t.trackSize,
                    r = t.dragStartPos,
                    a = (t.getPointerPosition(e) - s.offset()[this.isHorizontal()
                        ? "left"
                        : "top"] - (null !== r
                            ? r
                            : a / 2)) / (n - a);
