	...
	<p class="woocommerce-mini-cart__empty-message">
		<script type="text/javascript">
			if (window.location.pathname.charAt(3) !== '/') {
				document.getElementsByClassName('woocommerce-mini-cart__empty-message')[0].innerHTML = 'Корзина пуста';
			}
			if (window.location.pathname.charAt(1) == 'e' && window.location.pathname.charAt(2) == 'n' && window.location.pathname.charAt(3) == '/') {
				document.getElementsByClassName('woocommerce-mini-cart__empty-message')[0].innerHTML = 'Your cart is empty';
			}
			if (window.location.pathname.charAt(1) == 'e' && window.location.pathname.charAt(2) == 'e' && window.location.pathname.charAt(3) == '/') {
				document.getElementsByClassName('woocommerce-mini-cart__empty-message')[0].innerHTML = 'Teie ostukorv on tühi';
			}
		</script>
	</p>
