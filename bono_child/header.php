...
<head>
	...
	<script>
		...
		function edfjgniu3h() {
			if (document.getElementById('primary') !== null) {
				setTimeout(function() {
					document.getElementById('primary').setAttribute('style', 'opacity: 1 !important; transition: 200ms;');
				}, 500);
			} else {
	...
	<script>
		...
		if (window.location.pathname.substr(0, 13) == '/ee/checkout/') {
			function checkoutLoopEe() {
				...
				if (document.getElementsByClassName('page-title').length > 0) {
					if (document.getElementsByClassName('page-title')[0].innerHTML == 'Kassas') {
						document.getElementsByClassName('page-title')[0].innerHTML = 'Kassa'
					}
				}
				...
				if (document.getElementsByClassName('select2-results__option').length > 0) {
					document.getElementsByClassName('select2-results__option')[0].getElementsByTagName('span')[0].innerHTML = 'Valige tarne asukoht';
				}
		...
		if (window.location.pathname.substr(0, 13) == '/en/checkout/') {
			function checkoutLoopEn() {
				...
				if (document.getElementsByClassName('select2-results__option').length > 0) {
					document.getElementsByClassName('select2-results__option')[0].getElementsByTagName('span')[0].innerHTML = 'Select delivery location';
				}
				if (document.getElementById('place_order') !== null) {
...
<body <?php body_class(); ?>>
	...
	<script>
		if (document.location.pathname == '/product/life-clinic/' || document.location.pathname == '/ee/product/life-clinic/' || document.location.pathname == '/en/product/life-clinic/') {
			document.getElementById('styleLife').innerHTML = '<style>.woocommerce-notices-wrapper {display: none !important;}</style>'
		}
	</script>
	<div id="cartHead"></div>
	...
	<script>
		...
		window.onload = setTimeout(function() {
			if (window.location.pathname.substr(3, 6) == '/cart/' || window.location.pathname.substr(0, 6) == '/cart/') {
				if (document.getElementById('masthead') == null) {
					document.getElementById('cart-header').outerHTML = sessionStorage['cart-header'];
				}
			}
		}, 100);
	</script>
				...
				<script>
					setTimeout(function() {
						if (window.location.pathname.substr(0, 4) == '/ee/') {
							...
							document.getElementsByClassName('header-cart')[0].getElementsByTagName('a')[0].setAttribute('href', '/ru/cart/');
						}
					}, 100);

					if (window.location.pathname.substr(0, 4) == '/ee/') {
						window.onload = function() {
							if (document.getElementsByClassName('header-cart__link header-favorite header-favorite--vis js-header-favorite').length > 0) {
								document.getElementsByClassName('header-cart__link header-favorite header-favorite--vis js-header-favorite')[0].setAttribute('href', '/ee/favorite/')
							};
							if (document.getElementsByClassName('header-cart__link header-compare header-compare--vis js-header-compare').length > 0) {
								document.getElementsByClassName('header-cart__link header-compare header-compare--vis js-header-compare')[0].setAttribute('href', '/ee/compare/')
							};
